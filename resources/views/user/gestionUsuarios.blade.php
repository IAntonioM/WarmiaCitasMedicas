...
@section('contenido')
    ...
    <div class="d-md-flex justify-content-md-end">
        <form action="{{route("gestionUsuarios")}}" method="GET" class="d-flex align-items-center">
            ...
            <div class="mb-4">
                <div class="mb-4">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create">Registrar Usuario <i class="fa-solid fa-square-plus"></i></button>
                </div>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            ...
                            <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#delete{{$usuario->id}}">Eliminar <i class="fa-solid fa-circle-xmark"></i></button>
                        </td>
                    </tr>
